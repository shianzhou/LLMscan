...
def cache_name(dataset_name, n_last_layers):
    return f"{dataset_name}_{MODEL_NAME}_last{n_last_layers}_{POOLING_VERSION}_samples{SAMPLE_COUNTS[dataset_name]}.npz"
...
def write_markdown(results, output_path):
    ...
    with output_path.open("w", encoding="utf-8") as file:
        ...
        file.write("> 固定 Qwen2.5-1.5B-Instruct、AutoDAN、last-token pooling，只改变最后层数。\n")
...
def main():
    ...
    parser.add_argument("--output_dir", default="outputs_hiddenstate/qwen2.5-1.5b/ablations/AutoDAN_layers_lasttoken_v2")
    parser.add_argument("--main_cache_dir", default="outputs_hiddenstate/qwen2.5-1.5b/cache")
